...
function gridz_custom_fonts() {
    $list = array(
        ...
        "font-family:'Gotham-Light';font-weight:normal;" => array("value" => "font-family:'Gotham-Light';font-weight:normal;", "label" => __("Gotham-Light","gridz")),
        "font-family:'Gotham-Bold_1';font-weight:normal;" => array("value" => "font-family:'Gotham-Bold_1';font-weight:normal;", "label" => __("Gotham-Bold_1","gridz")),
        "font-family:'Gotham-Medium';font-weight:normal;" => array("value" => "font-family:'Gotham-Medium';font-weight:normal;", "label" => __("Gotham-Medium","gridz")),
        "font-family:'Gotham-Book';font-weight:normal;" => array("value" => "font-family:'Gotham-Book';font-weight:normal;", "label" => __("Gotham-Book","gridz")),
    );
